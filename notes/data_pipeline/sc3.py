...
x_input_data = tf.Print(x_input_data, data=[
                        x_input_data], message="Raw inputs data generated:", summarize=6)
...
input = q.dequeue()
input = tf.Print(input, data=[q.size(), input],
                 message="Nb elements left, input:")
